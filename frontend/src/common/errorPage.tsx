  ...
  return (
    <div id="error-page">
      ...
      <div className="main-error-page" >
        <svg xmlns="http://www.w3.org/2000/svg"className="rotating-svg"  xmlnsXlink="http://www.w3.org/1999/xlink" width="auto" height="290" viewBox="0 0 470 290">
          <defs>
            <path
              id="prefix__a"
          ...
          <g fill="none" fill-rule="evenodd">
            ...
            <g>
              ...
              <g className="raios" stroke="#fdba55" stroke-linecap="round" stroke-width="1.8">
        ...
        <h1 className="error-svg-text">
          Woops! <br />
          Something went wrong :(
        </h1>
        <h3 className="error-svg-text">Have you tried turning it off and on again?</h3>
      </div>
    </div>
  );
}
